...
def genTable(usvState, latestMsg, usvCAN, usvPose, usvComm, dt, uSP, vSP, psiSP, rSP, xSP, ySP):    
...
class USVData():
    ...
    def saveData(self, usvCAN, usvPose, usvComm, dt, uSP, vSP, psiSP, rSP, xSP, ySP):       
