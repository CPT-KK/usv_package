...
COMM_TEST_SUAV_STATES_ALLOWED = ["COMM_TEST", "READY", "COUNTDOWN", "SEARCH", "GUIDE"]
COMM_TEST_TUAV1_STATES_ALLOWED = ["COMM_TEST", "READY", "WAIT"]
READY_SUAV_STATES_ALLOWED = ["COUNTDOWN", "SEARCH", "GUIDE"]
